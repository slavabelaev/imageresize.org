...
// Styles
import styles from './PDF_ResizePage.styles';

class PDF_ResizePage extends React.Component {
    state = {  }
    render() {
...
PDF_ResizePage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(PDF_ResizePage);