...
// Styles
import styles from './Convert_JPG_to_PNG_Page.styles';

class Convert_JPG_to_PNG_Page extends React.Component {
    state = {  }
    render() {
            ...
            <div className={`${props.className || ''} ${classes.root}`}>
                <div className={classes.contentContainer}>
                    <header className={classes.header}>
                        <Typography variant="h4" component="h1">Convert JPG to PNG</Typography>
...
Convert_JPG_to_PNG_Page.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(Convert_JPG_to_PNG_Page);