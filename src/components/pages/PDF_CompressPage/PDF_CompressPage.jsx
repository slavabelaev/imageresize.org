...
// Styles
import styles from './PDF_CompressPage.styles';

class PDF_CompressPage extends React.Component {
    state = {  }
    render() {
            ...
            <div className={`${props.className || ''} ${classes.root}`}>
                <div className={classes.contentContainer}>
                    <header className={classes.header}>
                        <Typography variant="h4" component="h1">PDF Compress</Typography>
...
PDF_CompressPage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(PDF_CompressPage);