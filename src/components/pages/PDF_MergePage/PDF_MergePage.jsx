...
// Styles
import styles from './PDF_MergePage.styles';

class PDF_MergePage extends React.Component {
    state = {  }
    render() {
            ...
            <div className={`${props.className || ''} ${classes.root}`}>
                <div className={classes.contentContainer}>
                    <header className={classes.header}>
                        <Typography variant="h4" component="h1">PDF Merge</Typography>
...
PDF_MergePage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(PDF_MergePage);